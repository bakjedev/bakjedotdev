...
public class BakjeSubscriber {
    ...
    public BakjeSubscriber(Object target, String methodName, Class<? extends Event> eventClass) {
        this(target, MethodUtils.getAccessibleMethod(target.getClass(), methodName, eventClass), eventClass);
    }

    public BakjeSubscriber(Object target, Method method) {
        this(target, method, getEvent(method));
    }

    public BakjeSubscriber(Object target, Method method, Class<? extends Event> eventClass) {
        try {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof BakjeSubscriber) {
            BakjeSubscriber that = (BakjeSubscriber) obj;
