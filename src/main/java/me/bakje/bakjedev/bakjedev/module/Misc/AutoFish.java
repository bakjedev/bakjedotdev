...
public class AutoFish extends Mod {
    ...
    public void onTick() {
        ...
        if (!threwRod && mc.player.fishHook == null && !fishMode.isMode("Passive")) {
            Hand newHand = fishMode.isMode("Aggressive") ? InventoryUtil.selectSlot(getBestRodSlot()) : getHandWithRod();
            if (newHand != null) {
                // throw again
